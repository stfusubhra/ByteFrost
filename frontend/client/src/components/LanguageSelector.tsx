...
interface LanguageSelectorProps {
  /** "light" = designed for dark navbar (Home/premium-landing)
   *  "dark"  = designed for light navbar (PublicLayout)  */
  variant?: "light" | "dark";
}
  ...
  return (
    <div className={`lang-selector lang-selector--${variant}`} ref={ref}>
      ...
      >
        ...
        <ChevronDown size={12} aria-hidden="true" className={open ? "rotated" : ""} />
      </button>

      {open && (
        <ul className="lang-selector-dropdown" role="listbox" aria-label="Available languages">
          {LANGUAGES.map((l) => (
